Attribute VB_Name = "EC_Markup_Gen_old"
Option Explicit

Public Sub ec_markup_generator_old()
...
Private Sub compare_BoMs(ref_BoM_IDs, sb_start_row)
    ...
    For counter = LBound(ref_BoM_IDs, 1) To UBound(ref_BoM_IDs, 1)
        ...
        rb_description = Trim(ref_BoM_IDs(counter, 4))
        rb_mfg = Trim(ref_BoM_IDs(counter, 5))
        rb_mfg_id = Trim(ref_BoM_IDs(counter, 6))
