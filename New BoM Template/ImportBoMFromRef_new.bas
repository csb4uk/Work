Attribute VB_Name = "ImportBoMFromRef_new"
Option Explicit

Public Sub import_BoM_from_ref_job_new()
...
Function get_BoM_IDs(ByVal rs_name As String, ByRef rb_start_row As Integer, ByRef rb_last_row As Integer)
    ...
    '===============================================================================================================================================
    get_BoM_IDs = Worksheets(rs_name).Range("A" & rb_start_row & ":N" & rb_last_row).Value
End Function
...
Private Sub populate_BoM(ref_BoM_IDs, sb_start_row, sb_row_counter)
    ...
    For BoM_ID_counter = LBound(ref_BoM_IDs, 1) To UBound(ref_BoM_IDs, 1)
        ...
        ElseIf IsNumeric(Mid(id_no, 1, 1)) = False And Mid(id_no, 1, 1) <> "" Then
            id_no = UCase(id_no)
            Range("F" & sb_row_counter).Value = ref_BoM_IDs(BoM_ID_counter, 6)
            highlight_cells sb_row_counter, Range("F" & sb_row_counter).Column
            
            Range("I" & sb_row_counter).Value = ref_BoM_IDs(BoM_ID_counter, 9)
            highlight_cells sb_row_counter, Range("I" & sb_row_counter).Column
            
            Range("N" & sb_row_counter).NumberFormat = "@"
            Range("N" & sb_row_counter).Value = ref_BoM_IDs(BoM_ID_counter, 14)
        ...
        '=======================================================================================================================================
        ElseIf id_no = "" Then
            If ref_BoM_IDs(BoM_ID_counter, 6) <> "" Then
                Range("F" & sb_row_counter).Value = ref_BoM_IDs(BoM_ID_counter, 6)
                highlight_cells sb_row_counter, Range("F" & sb_row_counter).Column
        ...
        Range("D" & sb_row_counter).Value = ref_BoM_IDs(BoM_ID_counter, 4)
